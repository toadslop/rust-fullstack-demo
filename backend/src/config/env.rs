use shared::{
    ...
    DATABASE_PROTOCOL_KEY, DATABASE_USER_KEY, DEFAULT_BACKEND_URL, DEFAULT_DB_URL,
    DEFAULT_FRONTEND_URL, FRONTEND_HOST_KEY, FRONTEND_PORT_KEY, FRONTEND_PROTOCOL_KEY,
};
